<div class="left-sidebar"><!-- Left sidebar starts here -->
  <div class="row-fluid">
    <div class="span12">
      ...
      <?php echo form_open('customer/add_save', array('id'=>'ajaxForm', 'method'=>'post', 'class'=>'form-horizontal no-margin')); ?>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <?php echo form_input(array('name'=>'c_name', 'value'=>isset($post["c_name"])? $post["c_name"]: "", 'class'=>'span5', 'required'=>'required', 'type'=>'text', 'placeholder'=>'客户名称')); ?><span class="help-inline "><font color="red">*</font></span>
          </div>
        </div>
